...
def load_dataset(args, corpus_type, shuffle):
    """
    Dataset generator that will be postponed to the first loading time and returns a list of lazily loaded datasets.
    ...
    def _lazy_dataset_loader(pt_file, corpus_type):
        ...
        logger.info("Loading %s dataset with %d number of examples from %s" % (corpus_type, len(dataset), pt_file))
