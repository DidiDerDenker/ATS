...
class Beam(object):
    ...
    def advance(self, word_probs, attn_out):
        ...
        attn_out, it computes and updates the beam search.
        ...
        * attn_out: attention at the last step
        ...
        # The best_scores_id is flattened beam x word array, so calculate where each word and beam score came from
...
class GNMTGlobalScorer(object):
    """
    NMT re-ranking score from the paper "Google's Neural Machine Translation System".
