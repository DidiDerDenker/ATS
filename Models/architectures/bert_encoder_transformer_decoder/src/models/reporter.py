    ...
    * _report_step
    ...
    def __init__(self, report_every, start_time=-1.):
        ...
        Args:
            ...
            start_time(float): manually set report start time, negative values mean that you should use start()
        """
...
class Statistics(object):
    ...
    * elapsed time
    ...
    def output(self, step, num_steps, learning_rate, start):
        ...
        t = self.elapsed_time()
        logger.info(
            ("Step %2d/%5d; acc: %6.2f; ppl: %5.2f; xent: %4.2f; lr: %7.8f; %3.0f/%3.0f tok/s; %6.0f sec")
            % (step, num_steps,
               self.accuracy(),
               self.ppl(),
               self.xent(),
