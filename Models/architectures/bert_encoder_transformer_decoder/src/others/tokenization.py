...
class BertTokenizer(object):
    """ Runs end-to-end tokenization with punctuation splitting and word-piece. """
    ...
    def convert_ids_to_tokens(self, ids):
        """ Converts a sequence of ids in word-piece tokens using the vocab. """
        tokens = []
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, cache_dir=None, *inputs, **kwargs):
        """ Instantiate a PreTrainedBertModel from a pre-trained model file, e.g. download and cache it if needed. """
        ...
        try:
            ...
            logger.error(
                ...
                .format(pretrained_model_name_or_path, ", ".join(PRETRAINED_VOCAB_ARCHIVE_MAP.keys()), vocab_file))
...
class BasicTokenizer(object):
    """ Runs basic tokenization with punctuation splitting, lower casing, etc. """
    ...
    def __init__(self, do_lower_case=True, never_split=("[UNK]", "[SEP]", "[PAD]", "[CLS]", "[MASK]")):
        ...
        Args:
          do_lower_case: whether to lower case the input or not
        """
...
class WordpieceTokenizer(object):
    ...
    def tokenize(self, text):
        ...
        Args:
          text: a single token or whitespace separated tokens, e.g. output from BasicTokenizer
