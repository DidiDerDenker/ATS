...
class BertData():
    ...
    def preprocess(self, src, tgt, sent_labels, use_bert_basic_tokenizer=False, is_test=False):
        ...
        tgt_subtokens_str = "[unused0] " + " [unused2] ".join(
            [" ".join(self.tokenizer.tokenize(" ".join(tt), use_bert_basic_tokenizer=use_bert_basic_tokenizer))
...
def load_xml(p):
    ...
    title_node = list(root.iter("hedline")) # headline
...
def tokenize(args):
    ...
    if num_orig != num_tokenized:
        raise Exception(
            ...
            "Was there an error during tokenization?" % (tokenized_stories_dir, num_tokenized, stories_dir, num_orig))
