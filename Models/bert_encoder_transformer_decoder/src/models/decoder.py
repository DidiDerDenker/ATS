...
class TransformerDecoderLayer(nn.Module):
    """
    Args:
      d_model (int): the dimension of keys/values/queries in MultiHeadedAttention, also the input size of the first-layer of the PositionwiseFeedForward
    ...
    def forward(self, inputs, memory_bank, src_pad_mask, tgt_pad_mask,
        ...
        mid = self.context_attn(memory_bank, memory_bank, query_norm,
                                mask=src_pad_mask, layer_cache=layer_cache, type="context")
...
class TransformerDecoder(nn.Module):
    """
    The implementation of the Transformer-Decoder from the paper "Attention is All You Need".
    ...
    Args:
       ...
       embeddings (obj:onmt.modules.Embeddings): embeddings to use, should have positional encodings
    ...
    def forward(self, tgt, memory_bank, state,
        ...
        # Run the forward pass of the Transformer-Decoder
...
class TransformerDecoderState(DecoderState):
    ...
    def __init__(self, src):
        """
        Args:
            src (FloatTensor): a sequence of source words tensors with optional feature tensors, of size (len x batch).
        """
