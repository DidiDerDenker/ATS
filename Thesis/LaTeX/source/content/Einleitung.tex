...
\noindent
Nicht zuletzt sind die Ergebnisse positiv bedingt durch den Durchbruch und der freien Verfügbarkeit vortrainierter Modelle, wie beispielsweise \ac{BERT} \cite{DEV19} oder auch \ac{ELMO} \cite{PET18} sowie deren Weiterentwicklungen. Verschiedenste \ac{NLP}-Aufgaben wie die \ac{ATS} konnten hiervon sehr stark profitieren. Die konkreten Funktionsweisen werden ebenfalls im Verlauf dieser Arbeit offengelegt. Wissenschaftliche Publikationen, welche mit dieser Arbeit vergleichbar sind und in dieser Arbeit referenziert werden, lauten wie folgt:
